...
int main(int argc, char** argv) {
    ...
    do {
        ...
        printf("3. Imprime o tamanho da lista\n");
        ...
        printf("9. Remove e qualquer posição da lita\n");
        printf("10.Imprimi a lista\n");
        printf("11.Busca elemento por posição\n");
        printf("12. Buscar elemento por numero\n");
        printf("0.  Sair\n");
        ...
        switch (continuar) {
            ...
            case 3:
                x = tamanho_lista(li);
                printf("O tamanha da list é: %d", x);
                break;
           case 4:
           ...
           case 6:
            ...
            case 12:
                ...
                scanf("%d",&pos);
                if(consulta_lista_num(li, pos,&num))
                    printf(" O numero foi localizado!");
                else
                    printf("O numero nao foi localizado na lista!");
                break; 
